...
namespace VS.Utils
{
    public class ToolBox
    {
        ...
        public static void ColorScaleHexa(BinaryReader buffer, string Filename, int _w = 128)
        {
            buffer.BaseStream.Position = 0;
            int width = _w;
            int height = (int)buffer.BaseStream.Length / width / 2;
            ...
            File.WriteAllBytes(Application.dataPath + "/../Assets/Resources/Textures/Ex/color" + Filename + _w + ".png", bytes);
        }

        public static void GreyScaleHexa(BinaryReader buffer, string Filename, int _w = 128)
        {
            buffer.BaseStream.Position = 0;
            int width = _w;
            ...
            byte[] bytes = tex.EncodeToPNG();
            ToolBox.DirExNorCreate(Application.dataPath + "/../Assets/Resources/Textures/Ex/");
            File.WriteAllBytes(Application.dataPath + "/../Assets/Resources/Textures/Ex/" + Filename + _w + ".png", bytes);
        }
