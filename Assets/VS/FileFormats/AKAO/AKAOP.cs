...
namespace VS.FileFormats.AKAO
{
    ...
    public class AKAOP
    {
        ...
        private static readonly AKAOP[] EVENTS = new AKAOP[]
        {
            ...
            new AKAOP("Note On Do",         0xF0, 2),
            new AKAOP("Note On Do#",        0xF1, 2),
            new AKAOP("Note On Ré",         0xF2, 2),
            new AKAOP("Note On Ré#",        0xF3, 2),
            new AKAOP("Note On Mi",         0xF4, 2),
            new AKAOP("Note On Fa",         0xF5, 2),
            new AKAOP("Note On Fa#",        0xF6, 2),
            new AKAOP("Note On Sol",        0xF7, 2),
            new AKAOP("Note On Sol#",       0xF8, 2),
            new AKAOP("Note On La",         0xF9, 2),
            new AKAOP("Note On Si",         0xFA, 2),
            new AKAOP("Note On Si#",        0xFB, 2),
            new AKAOP("Tie FC",             0xFC, 2),
            new AKAOP("Rest FD",            0xFD, 2),
